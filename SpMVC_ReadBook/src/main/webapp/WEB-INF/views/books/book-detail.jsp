...
table#book-detail .dest-title th {
	text-align: left;
	padding: 10px 30px;
	color: white;
...
<table id="book-detail" >
	<tr class="title"><td colspan="2"><h1>${BOOKVO.title}</h1></td></tr>
	<tr class="info">
		<td><img src="${BOOKVO.image}"></td>
		<td>
			<table>
				<tr class=""><th>저자</th><td>${BOOKVO.author}</td>
					<td>${BOOKVO.pubdate}</td></tr>
				<tr class=""><th>가격</th><td>${BOOKVO.price}</td>
					<td>${BOOKVO.discount}</td></tr>
				<tr class=""><th>출판사</th><td>${BOOKVO.publisher}</td>
					<td>${BOOKVO.isbn}</td></tr>
			</table>
		</td>
	</tr>
	<tr><td class="dummy"></td></tr>
	<tr colspan="2"><th>책소개</th></tr>
	<tr colspan="2"><td>${BOOKVO.description}</td></tr>
	<tr class="link">
		<th>네이버도서정보</th>
	...
	<tr class="buy">
		...
		<p>구입가격 : ${BOOKVO.buyprice}
		<p>구입처 : ${BOOKVO.buystore}
	</tr>
</table>