...
public class MemberServiceImplV1 implements MemberService{
	...
	public int insert(UserDetailsVO userVO) {
		...
		// 1. 회원가입한 모든 사용자에게 기본값으로 권한을 부여하고
		...
		if(nCount > 0) {
			...
			// 2. 최초에 저장되는 회원은 roll_admin, roll_user 권한을 부여하여
		...
		// List 에 담겨 잇는 값을 DB insert할때
		// 가장 쉽게 할수 있는 방법이 List를 for 반복문으로 감싸고
		// vo 한개씩을 insert에 보내는 방법
		// 촌스러운방법이다.
...
//		}
		...
		//
		//
		// authority에는 insert가 되고 userDao는 insert가 안되는 상황이 되었다
