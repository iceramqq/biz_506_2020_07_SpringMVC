...
public class MemberController {
	...
	public String mypage(@ModelAttribute("memberVO") UserDetailsVO userVO,
		 ...
		 *  method의 매개변수로 설정된 authentication 클래스로 선언된 객체 에
		 *  담겨서
		 */
	...
	public UserDetailsVO userInfo(Principal principal,
			...
			,@AuthenticationPrincipal @ModelAttribute("memberVO") UserDetailsVO userVO,Model model) {
