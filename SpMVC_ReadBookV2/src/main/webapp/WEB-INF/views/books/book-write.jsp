...
<link href="${rootPath}/static/css/book-write.css?ver=2020-09-24?ver=2020-09-24-001" rel="stylesheet">
<script>
	var csrf_header = '${_csrf.headerName}'
	var csrf_token = '${_csrf.token}'
</script>
<script src="${rootPath}/static/js/book-write.js?ver=2020-09-24?ver=2020-10-07-004">
</script>
<h3>도서정보 등록</h3>
<form:form id="books" modelAttribute="bookVO">
	<fieldset>
		...
		<div><label for="discount">할인</label>
